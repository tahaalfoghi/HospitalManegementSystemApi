...
namespace HospitalManegementSystem.Controllers
{
    ...
    {
        private readonly IRepository<Prescription> _repo;
        private readonly ILogger<PrescriptionController> _logger;
        private readonly IMapper _mapper;

        public PrescriptionController(IRepository<Prescription> repo, ILogger<PrescriptionController> logger, IMapper mapper)
        {
            _repo = repo;
            _logger = logger;
            _mapper = mapper;
        ...
        public async Task<ActionResult<IEnumerable<PrescriptionDTO>>> GetAll()
        {
            try
            {
                ...
                var recordsDTO = _mapper.Map<HashSet<PrescriptionDTO>>(records);
                return recordsDTO;
            }
            catch (Exception e)
            {
        ...
        [ProducesResponseType(404)]
        [ProducesResponseType(500)]
        public async Task<ActionResult> Create([FromBody] PrescriptionDTO dto)
        {
            ...
            var record = _mapper.Map<Prescription>(dto);
        ...
        [ProducesResponseType(404)]
        [ProducesResponseType(500)]
        public async Task<ActionResult> Update(int id, PrescriptionDTO dto)
        {
            ...
            await _repo.UpdateAsync(id, prescription);
